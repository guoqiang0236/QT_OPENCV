...
"}"));
        ...
        gridLayout_4->setContentsMargins(11, 11, -1, -1);
        pushButton_openimage = new QPushButton(groupBox);
        pushButton_openimage->setObjectName("pushButton_openimage");

        gridLayout_4->addWidget(pushButton_openimage, 0, 0, 1, 1);

        pushButton_test = new QPushButton(groupBox);
        pushButton_test->setObjectName("pushButton_test");

        gridLayout_4->addWidget(pushButton_test, 1, 0, 1, 1);
...
"}"));
        ...
        gridLayout_3 = new QGridLayout(frame_main);
        ...
        graphicsView = new MyQGraphicsView(frame_main);
    ...
    void retranslateUi(QMainWindow *MainWindow_UI)
    {
        ...
        pushButton_openimage->setText(QCoreApplication::translate("MainWindow_UI", "\346\211\223\345\274\200\345\233\276\347\211\207", nullptr));
        pushButton_test->setText(QCoreApplication::translate("MainWindow_UI", "\346\265\213\350\257\225\345\212\237\350\203\275", nullptr));
